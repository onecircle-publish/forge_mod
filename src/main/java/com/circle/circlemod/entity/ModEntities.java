...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<CharmMushroomEntity>> CHARM_MUSHROOM_ENTITY = ENTITIES.register("charm_mushroom", () -> EntityType.Builder.<CharmMushroomEntity>of(CharmMushroomEntity::new, MobCategory.MISC).sized(1f, 1f).build("charm_mushroom"));
