...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<Ice>> ICE = ENTITIES.register("ice", () -> EntityType.Builder.<Ice>of(Ice::new, MobCategory.MISC).sized(0.5f, 1f).build(new ResourceLocation(CircleMod.MOD_ID, "ice").toString()));
