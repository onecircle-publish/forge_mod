...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<ShieldEntity>> SHIELD_ENTITY = ENTITIES.register("shield", () -> EntityType.Builder.<ShieldEntity>of(ShieldEntity::new, MobCategory.MISC).sized(1f, 1f).build(new ResourceLocation(CircleMod.MOD_ID, "shield").toString()));
